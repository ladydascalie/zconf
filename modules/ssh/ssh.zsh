...
if [ -f $allowed_signers_output ]; then
	_dbg "module(zsh) ~> $allowed_signers_output already exists, nothing to do."
else
	_dbg "module(zsh) ~> injecting $allowed_signers_template to $allowed_signers_output using 1password cli"
